...
contains(BLAZECOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += BLAZECOIN_NEED_QT_PLUGINS
...
contains(BLAZECOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = blazecoin-qt_test
DEFINES += BLAZECOIN_QT_TEST
...
macx:ICON = src/qt/res/icons/blazecoin.icns
