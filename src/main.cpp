...
uint256 hashGenesisBlock("0x5d871c1b6ea542c2bb8a3b3ac70028a591bbf81369e90c2446c1a2bbfb89459b");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Blazecoin: starting difficulty is 1 / 2^12
...
{
    // Blazecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1051200); // Blazecoin: 1.0512mil blocks in ~1 year
...
{
    // Blazecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe080efe20374dc557e935707c57a866189e14e26b21bf46d42f9d9a6f8c9b3cd");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
    // Genesis Block:
		// block.GetHash() = 5d871c1b6ea542c2bb8a3b3ac70028a591bbf81369e90c2446c1a2bbfb89459b
		// hashGenesisBlock = 5d871c1b6ea542c2bb8a3b3ac70028a591bbf81369e90c2446c1a2bbfb89459b
		// block.hashMerkleRoot = 76dac14606eb13388518e7581062b3d4aec84feb58d015a83c532bc5349618b8
		// CBlock(hash=5d871c1b6ea542c2bb8a, PoW=00000d7fde6d8163e09b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=76dac14606, nTime=1400442576, nBits=1e0ffff0, nNonce=595109, vtx=1)
    //   CTransaction(hash=76dac14606, ver=1, vin.size=1, vout.size=1, nLockTime=0)
    //   CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d01044c55486177616969616e2053757266696e67204d6f64656c2043686172676564205769746820417474656d70746564204d757264657220696e20416c6c6567656420526f616420526167652048697420616e642052756e)
    ...
    //   vMerkleTree: 76dac14606
        ...
        assert(block.hashMerkleRoot == uint256("0x76dac14606eb13388518e7581062b3d4aec84feb58d015a83c532bc5349618b8"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Blazecoin: increase each by adding 2 to blazecoin's value.
...
void GenerateBlazecoins(bool fGenerate, CWallet* pwallet)
{
