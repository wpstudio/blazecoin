    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString titleText       = QString(""); // cut of testnet, place it as single object further down
    QString versionText     = QString("");
    //QString copyrightText   = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("Dr. Kimoto Chan"));
	QString copyrightText   = QString("");
    QString testnetAddText  = QString(""); // define text to place as single text object
