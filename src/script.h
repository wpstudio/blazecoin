...
#ifndef H_BLAZECOIN_SCRIPT
#define H_BLAZECOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CBlazecoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Blazecoin always counted CHECKMULTISIGs
