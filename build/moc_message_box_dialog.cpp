/****************************************************************************
** Meta object code from reading C++ file 'message_box_dialog.h'
**
...
#include "../src/qt/message_box_dialog.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'message_box_dialog.h' doesn't include <QObject>."
...
void MessageBoxDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData MessageBoxDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MessageBoxDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MessageBoxDialog,
      qt_meta_data_MessageBoxDialog, &staticMetaObjectExtraData }
};
