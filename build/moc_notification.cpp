...
static const char qt_meta_stringdata_Notification[] = {
    "Notification\0\0removeNotificationRequested()\0"
};
...
void Notification::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->removeNotificationRequested(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Notification::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Notification::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Notification,
      qt_meta_data_Notification, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Notification::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Notification))
